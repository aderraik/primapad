...
class gsp_justpad_notepadcreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/notepad/create.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',25,['bean':(this.notepad),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(this.notepad)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
invokeTag('textField','g',30,['name':("chave")],-1)
printHtmlPart(20)
...
public static final long LAST_MODIFIED = 1478397514000L
