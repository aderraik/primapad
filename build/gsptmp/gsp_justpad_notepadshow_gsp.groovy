...
class gsp_justpad_notepadshow_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/notepad/show.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(12)
invokeTag('display','f',22,['bean':("notepad")],-1)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(13)
createTagBody(3, {->
...
invokeTag('link','g',25,['class':("edit"),'action':("edit"),'resource':(this.notepad)],3)
printHtmlPart(14)
...
invokeTag('form','g',28,['resource':(this.notepad),'method':("DELETE")],2)
printHtmlPart(17)
})
...
public static final long LAST_MODIFIED = 1478364437000L
