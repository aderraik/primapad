...
class gsp_justpad_notepadindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/notepad/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(11)
invokeTag('table','f',21,['collection':(notepadList)],-1)
printHtmlPart(12)
invokeTag('paginate','g',24,['total':(notepadCount ?: 0)],-1)
printHtmlPart(13)
})
